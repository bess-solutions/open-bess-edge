import pytest
from src.interfaces.metrics import generate_metrics, CARBON_VIABILITY_SCORE, INJECTION_KW_CAPACITY, FLEET_LATENCY_MS
...
def test_fleet_coordinator_exports_injection_kw():
    ...
    metrics_out = generate_metrics().decode("utf-8")
    expected_metric_line = f'bess_injection_kw_capacity{{fleet_site="test_fleet_site",site_id="edge"}} 400.0'
    assert expected_metric_line in metrics_out
