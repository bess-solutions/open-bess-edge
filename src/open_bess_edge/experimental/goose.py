...
logger = logging.getLogger("open_bess_edge.experimental.goose")
...
@dataclass
class GOOSEMessage:
    gocb_ref: str = "OBE_BAY01/LLN0$GO$gcbTrip"
    time_allowed_to_live_ms: int = 4000
    dataset: str = "OBE_BAY01/LLN0$DS_FAST_TRIP"
...
class GOOSETransceiver:
    ...
    def publish_trip(self, cause: TripCause, gocb_ref: str = "OBE_BAY01/LLN0$GO$gcbTrip") -> GOOSEMessage:
    ...
    def publish_heartbeat(self, gocb_ref: str = "OBE_BAY01/LLN0$GO$gcbTrip") -> GOOSEMessage:
