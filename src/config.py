...
class ModbusConfig(BaseModel):
    ...
    simulation_mode: bool = Field(default=True, description="Modo simulación en caso de no contar con hardware físico")
    ...
    reg_q_actual_kvar: int = Field(default=103, description="Potencia reactiva actual (+ = inductivo, - = capacitivo)")
...
class EdgeConfig(BaseModel):
    ...
    @classmethod
    def load_from_yaml(cls, path: Optional[Path] = None) -> "EdgeConfig":
