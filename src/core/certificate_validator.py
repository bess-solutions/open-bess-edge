...
class BESSComplianceVerifier:
    ...
    """
    def __init__(self, public_key_pem: bytes | None = None, public_key_obj: ec.EllipticCurvePublicKey | None = None):
        if public_key_obj:
            ...
            raise ValueError("Debe proveer la llave pública en formato PEM o como objeto EllipticCurvePublicKey.")
